...
(defmethod serialize String [s]
  (let [data (.getBytes s)
    ...
    (cond
      (<= size 0x1f)
        (ubyte-array (cons (bit-or 2r10100000 size) data))
      (<= size 0xff)
        (ubyte-array (concat [0xd9] (get-byte-bytes size) data))
      (<= size 0xffff)
        (ubyte-array (concat [0xda] (get-short-bytes size) data))
      (<= size 0xffffffff)
        (ubyte-array (concat [0xdb] (get-int-bytes size) data)))))
...
(defmethod serialize ::byte-array
  ...
  (let [size (count data)]
    (cond
      (<= size 0xff)
        (ubyte-array (concat [0xc4] (get-byte-bytes size) data))
      (<= size 0xffff)
        (ubyte-array (concat [0xc5] (get-short-bytes size) data))
      (<= size 0xffffffff)
        (ubyte-array (concat [0xc6] (get-int-bytes size) data)))))
...
(defmethod serialize ::array
  ...
  (let [size (count coll)
    ...
    (cond
      (<= size 0xf)
        (ubyte-array (cons (bit-or 2r10010000 size) data))
      (<= size 0xffff)
        (ubyte-array (concat [0xdc] (get-short-bytes size) data))
      (<= size 0xffffffff)
        (ubyte-array (concat [0xdd] (get-int-bytes size) data)))))
...
(defmethod serialize ::map
  ...
  (let [size (count coll)
    ...
    (cond
      (<= size 0xf)
        (ubyte-array (cons (bit-or 2r10000000 size) data))
      (<= size 0xffff)
        (ubyte-array (concat [0xde] (get-short-bytes size) data))
      (<= size 0xffffffff)
        (ubyte-array (concat [0xdf] (get-int-bytes size) data)))))
