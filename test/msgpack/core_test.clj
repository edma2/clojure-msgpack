...
;    (packable [true 1 (reify-ext 3 (.getBytes "foo")) 0xff {1 false 2 "abc"} (ubyte-array [0x80]) [1 2 3] "abc"]
...
;(deftest ext-test
;  (testing "fixext 1"
;    (packable (reify-ext 5 [0x80]) [0xd4 0x05 0x80]))
;  (testing "fixext 2"
;    (packable (reify-ext 5 [0x80 0x80]) [0xd5 0x05 0x80 0x80]))
;  (testing "fixext 4"
;    (packable (reify-ext 5 [0x80 0x80 0x80 0x80])
;                   [0xd6 0x05 0x80 0x80 0x80 0x80]))
;  (testing "fixext 8"
;    (packable (reify-ext 5 [0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80])
;                   [0xd7 0x05 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80]))
;  (testing "fixext 16"
;    (packable (reify-ext 5 (repeat 16 0x80))
;                   (concat [0xd8 0x05] (repeat 16 0x80))))
;  (testing "ext 8"
;    (packable (reify-ext 55 [0x1 0x3 0x11])
;                   [0xc7 0x3 0x37 0x1 0x3 0x11])
;    (packable (reify-ext 5 (repeat 255 0x80))
;                   (concat [0xc7 0xff 0x05] (repeat 255 0x80))))
;  (testing "ext 16"
;    (packable (reify-ext 5 (repeat 256 0x80))
;                   (concat [0xc8 0x01 0x00 0x05] (repeat 256 0x80))))
;  (testing "ext 32"
;    (packable (reify-ext 5 (repeat 65536 0x80))
