...
(deftest int-test
  (testing "ints"
    ...
    ; 64-bit uint
    (is (= (unsigned-bytes [0xcf 0x00 0x00 0x00 0x01 0x00 0x00 0x00 0x00])
           (serialize 0x100000000)))
    (is (= (unsigned-bytes [0xcf 0x00 0x00 0x20 0x00 0x00 0x00 0x00 0x00])
           (serialize 0x200000000000)))
    (is (= (unsigned-bytes [0xcf 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff])
           (serialize 0xffffffffffffffff)))
    ; 64-bit int
    (is (= (unsigned-bytes [0xd3 0xff 0xff 0xff 0xff 0x7f 0xff 0xff 0xff])
           (serialize -2147483649)))
    (is (= (unsigned-bytes [0xd3 0xf2 0x1f 0x49 0x4c 0x58 0x9b 0xff 0xfe])
           (serialize -1000000000000000002)))
    (is (= (unsigned-bytes [0xd3 0x80 0x00 0x00 0x00 0x00 0x00 0x00 0x00])
